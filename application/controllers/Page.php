...
class Page extends CI_Controller
{
   ...
   public function loket($id = null)
   {
      ...
      $data['tampilan'] = "loket";
      $data['text_jalan'] = $this->M_crud->show('text_jalan', 'id_text DESC')->result();
      $config['base_url']       = site_url('admin/konten/loket/');;
   ...
   public function instansi($id = null)
   {
      $data['instansi'] = $this->M_crud->show('instansi', 'id_instansi DESC')->row();
      //$data['perhari'] = $this->M_crud->get_group_id('transaksi', 'tgl')->result();
      $data['content'] = 'instansi';
      $data['tampilan'] = "instansi";
      $data['text_jalan'] = $this->M_crud->show('text_jalan', 'id_text DESC')->result();
   ...
   public function agenda($id = null)
   {
      ...
      //$data['perhari'] = $this->M_crud->get_group_id('transaksi', 'tgl')->result();
      $data['content'] = 'agenda';
      $data['tampilan'] = 'agenda';
      $data['text_jalan'] = $this->M_crud->show('text_jalan', 'id_text DESC')->result();
      $config['base_url']       = site_url('admin/konten/agenda/');
   ...
   {
      $data['instansi'] = $this->M_crud->show('instansi', 'id_instansi DESC')->row();
      $data['content'] = 'text_jalan';
      $data['tampilan'] = 'text_jalan';
      $config['base_url']       = site_url('admin/konten/text_jalan/');
